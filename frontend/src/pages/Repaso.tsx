...
export function Repaso() {
  ...
  return <div className="mx-auto max-w-2xl px-4 py-7 sm:px-8 sm:py-10">
    ...
    <section className="mt-6 rounded-3xl bg-paper p-5 shadow-card sm:p-7">
      ...
      {item.previous_incorrect_answer && item.options && <p className="mt-3 rounded-2xl bg-blush px-4 py-2 text-sm font-semibold text-terracotta">Tu última respuesta incorrecta: {item.previous_incorrect_answer}</p>}
