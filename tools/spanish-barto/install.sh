...
uv pip install --python "$model_home/venv/bin/python" 'transformers==4.57.6' 'sentencepiece==0.2.1' 'pysbd==0.3.4' 'safetensors>=0.4.3,<1'
...
printf '\nInstalled Spanish BARTO correction model at %s\nRun: %s/test.sh\n' "$model_home" "$script_dir"
