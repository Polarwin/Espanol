"""Short lessons cut from the user's incoming Spanish video library."""

from typing import Any

LIBRARY = "/srv/files/ytwatcher/Espanol"
...
VIDEO_LESSONS = [
    _lesson("video-a1-aprender-juntos", "Aprender juntos", "A1", ["estudios", "amistad"], f"{LIBRARY}/20 Basic Spanish Conversations for Beginners (A1-A2) Dialogues that Everyone Should Know [ua6MUhU7Lqc].webm", 10, 109,
    ...
    _lesson("video-a2-ruta-senderismo", "Una ruta de senderismo", "A2", ["planes", "naturaleza"], f"{LIBRARY}/10 Natural Spanish Conversations for Beginners (A1–A2) ｜ Discussing Weekend Plans [NzqskjXnd5E].webm", 20, 162,
    ...
    _lesson("video-b1-mensajes-intencion", "Mensajes con intención", "B1", ["comunicación", "trabajo"], f"{LIBRARY}/Spain/MasterSpanish/B1/HOW TO ANSWER THE PHONE in Spanish ｜ Step by Step (FREE COURSE) w⧸book Aula 3 Lesson 77! [4Hd5Z9zZRqs].mkv", 155, 280,
